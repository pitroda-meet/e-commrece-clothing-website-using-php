...
<body class="bg-light">
    <div class="container">
        <h1 class="text-center">Insert slider_image women</h1>
        <form id="insert_slider" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-outline mb-4">
                <label for="slider_image" class="form-label fs-5 fw-bold">slider image wommen:</label>
                <input type="file" class="form-control" name="slider_image" id="slider_image" >
                <p id="slider_image_error" class="form-error"></p>
            </div>

            <div class="form-outline mb-4">
                <input type="submit" class="btn btn-info form-control" value="Insert Product" name="womenslider_image">
            </div>
        </form>
    </div>
