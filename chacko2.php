    ...
    <div class="">
        ...
        <div class="" style="min-height: 1024px;">
            ...
            <div class="container mt-3">
                <div class="row">
                    <div class="col-md-9">
                        <h2 class="text-center">basic detail</h2>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card">
                            ...
                            <div class="card mb-3" style="max-width: 540px;">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img src="./admin_area/product_images/<?php echo $fetch_cart['image']; ?>"
                                ...
                                <li class="list-group-item d-flex justify-content-between lh-sm">
                                    <li class="list-group-item d-flex justify-content-between bg-light">
                                        <div class="text-success">
                                            ...
                                            <small id="appliedCoupon">SALE500</small>
                                        </div>
                            ...
                            <div class="mb-3 input-group">
                                <label for="coupon" class="input-group-text">Discount Coupon</label>
                                <input type="text" class="form-control" id="coupon" name="coupon">
                                <button class="btn btn-outline-secondary" type="button">Apply</button>
                                <p id="couponError" class="error"></p>
                            </div>
                        </div>
